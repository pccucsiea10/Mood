...
public class NotificationListenerService extends android.service.notification.NotificationListenerService {
    ...
    private com.ehappy.service.PhoneReceiver mPhoneReceiver = null;
    ...
    public void onCreate() {
        ...
        mPhoneReceiver = new com.ehappy.service.PhoneReceiver();
    ...
    public static void doSendIncomingEventToDevice(AppContract.emIncomingMessageType type, String message, String packageName) {
        ...
        if (Status._goFITSdk != null) {
            Status._goFITSdk.doSendIncomingMessage(type, message, packageName);
        }
    }
}
